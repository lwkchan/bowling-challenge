  ...
  describe('roll', function () {
    ...
    describe('rolling a strike', function () {
      ...
      it('rolling consecutively throughout the game garners perfect score of 300', function () {
        ...
        bowlingGame.roll(10)
        bowlingGame.roll(10)
        console.log('framecounter:   9')
        console.log(bowlingGame.frameCounter)
        console.log('totalscore: we want 270')
        console.log(bowlingGame.totalScore)
        bowlingGame.roll(10)
        console.log('framecounter:   10')
        console.log(bowlingGame.frameCounter)
        bowlingGame.roll(10)
        bowlingGame.roll(10)
        console.log('framecounter:   10')
        console.log(bowlingGame.frameCounter)
        console.log('rollcount: we want  2')
        console.log(bowlingGame.rollCount)
        console.log('has extra roll: we want  true')
        console.log(bowlingGame.hasExtraRoll)
        console.log('total score:   we want 290')
        console.log(bowlingGame.totalScore)
        bowlingGame.roll(10)
